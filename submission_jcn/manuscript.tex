...
All 50 runs passed the preregistered quality checks: ten rows per protocol,
...
\textbf{FUNDING INFORMATION REQUIRED FROM AUTHOR}
...
Scripts, raw data, validation outputs, and figure-generation materials are
available from
\href{https://github.com/Uxuee/PathAnisotropyCurvature}{https://github.com/Uxuee/PathAnisotropyCurvature}.

\textbf{ZENODO DOI REQUIRED BEFORE SUBMISSION}
